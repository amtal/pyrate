...
worth the effort right now.
    ...
    Modifications so far: just main() at the very bottom, and idlelib.imports.
'''
import os
import os.path
import sys
...
import idlelib.idlever as idlever

import idlelib.rpc as rpc
import idlelib.Debugger as Debugger
import idlelib.RemoteDebugger as RemoteDebugger
